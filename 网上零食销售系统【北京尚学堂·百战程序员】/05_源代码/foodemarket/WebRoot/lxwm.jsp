...
HashMap map = new CommDAO().getmap("3","news");
 %>
        ...
        <TR>
          <TD width=710 height="276" vAlign=top>
            <TABLE width="100%" height="274" border=0 cellPadding=0 cellSpacing=0>
              <TBODY>
              <TR>
                <TD height=27 background=foodemarket_files/tn.jpg>
                  <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
                    <TBODY>
                    <TR>
                      <TD width=20 height="28">
                        <DIV align=center><IMG src="foodemarket_files/icon01.jpg" 
                        width=9 height=26></DIV></TD>
                      <TD class=green_title01>联系我们 </TD>
                      <TD width=50>
